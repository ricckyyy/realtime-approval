    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 p-4">
      <div className="max-w-2xl mx-auto pt-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className={`border-2 rounded-lg p-8 mb-6 ${statusDisplay.color}`}>
            <div className="flex flex-col items-center text-center">
              {statusDisplay.icon}
              <h2 className="text-2xl font-bold mt-4 mb-2">{statusDisplay.label}</h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-500 mb-1">メッセージ</h3>
              <p className="text-gray-900 whitespace-pre-wrap">{request.message}</p>
            </div>
            <div>
              <h3 className="text-sm font-semibold text-gray-500 mb-1">送信日時</h3>
